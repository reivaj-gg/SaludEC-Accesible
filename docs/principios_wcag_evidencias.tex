...
\midrule
Perceptible & \textcolor{warningyellow}{\bfseries 91\%} & 1.1.1 alt text único, 1.3.1 semántica HTML, 1.4.10 responsive 320px. \textbf{Issue activo:} 1.4.3 contraste insuficiente en 2 elementos (WAVE + Lighthouse) \\
...
Robusto & \textcolor{warningyellow}{\bfseries 95\%} & 4.1.1 HTML válido, 4.1.3 aria-live. \textbf{Issue activo:} 4.1.2 atributos ARIA prohibidos en 2 elementos (Lighthouse) \\
\midrule
\textbf{Global WCAG 2.2 AA} & \textcolor{warningyellow}{\bfseries 92\%} & Lighthouse Accessibility 92/100 (03/07/2026); 4 criterios con cumplimiento parcial o issue activo \\
\bottomrule
\end{tabular}
\end{table}

\begin{okbox}[Declaración resumida de conformidad]
SaludEC cumple sustancialmente con los cuatro principios POUR de WCAG 2.2 Nivel AA. Lighthouse PageSpeed Insights (03/07/2026) otorga una puntuación de \textbf{92/100} en Accessibility, con dos issues activos en corrección: (1) atributos ARIA prohibidos en 2 elementos (principio Robusto, 4.1.2) y (2) contraste insuficiente en 2 elementos (principio Perceptible, 1.4.3). Dos criterios adicionales tienen cumplimiento parcial documentado con alternativas funcionales (2.5.7 y 3.2.6). El sitio \textbf{no presenta barreras que impidan} el acceso a la información de servicios públicos de salud para usuarios con discapacidades visuales, motrices, auditivas o cognitivas. Las correcciones restantes están planificadas para la semana del 07/07/2026 (Sprint 2).
\end{okbox}
