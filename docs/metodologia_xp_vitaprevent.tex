...
HU-19 & Corregir contraste: 2 errores WAVE/Lighthouse (1.4.3) & 2 & Jonathan Tipán & 2 \\
...
\midrule
\rowcolor{graylight}
\multicolumn{2}{@{}l}{\textbf{Total Sprint 2}} & \textbf{43} & & \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}
  ...
  \item \xmark~Lighthouse Accessibility: 92/100 al 03/07/2026 (objetivo $\geq$95/100 para entrega final; 2 issues activos: contraste y ARIA prohibido).
  \item \xmark~CLS (escritorio): 0.326 --- requiere corrección antes de entrega (objetivo $<$0.1).
\end{enumerate}
...
Lighthouse Accessibility (03/07/2026)   & 92 / 100 (2 issues activos) \\
PageSpeed Performance --- móvil         & 66 / 100 \\
PageSpeed Performance --- escritorio    & 80 / 100 \\
CLS (escritorio)                        & 0.326 (objetivo $<$0.1) \\
